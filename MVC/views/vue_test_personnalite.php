...
<head>
    ...
    <link rel="stylesheet" href="stylesheetMVC/test%20personnalité.css">
    <meta charset="UTF-8">
...
require('controllers/controlleur_test_personnalite.php');
        ...
        <form action="" method="post">
            ...
            <fieldset>
                ...
                <select id="question_1" name="question_1">
                    ...
                    <option value="Tous le temps">Tous le temps</option>
                </select><br>
                <?php
            ...
            <fieldset>
                ...
                <select id="question_6" name="question_6">
                ...
                <select id="question_7" name="question_7">
                    <option value="Pas" name="choix_1">Ne me correspond pas</option>
                    <option value="Un peu" name="choix_2">Me correspond un peu</option>
                    <option value="Beaucoup" name="choix_3">Me correspond beaucoup</option>
                    <option value="Parfaitement" name="choix_4">Me correspond parfaitement</option>
                ...
                <select id="question_8" name="question_8">
                    <option value="Pas" name="choix_1">Ne me correspond pas</option>
                    <option value="Un peu" name="choix_2">Me correspond un peu</option>
                    <option value="Beaucoup" name="choix_3">Me correspond beaucoup</option>
                    <option value="Parfaitement" name="choix_4">Me correspond parfaitement</option>
                ...
                <select id="question_10" name="question_10">
                    <option value="Pas" name="choix_1">Ne me correspond pas</option>
                    <option value="Un peu" name="choix_2">Me correspond un peu</option>
                    <option value="Beaucoup" name="choix_3">Me correspond beaucoup</option>
                    <option value="Parfaitement" name="choix_4">Me correspond parfaitement</option>
                ...
                <select id="question_11" name="question_11">
                    <option value="Pas" name="choix_1">Ne me correspond pas</option>
                    <option value="Un peu" name="choix_2">Me correspond un peu</option>
                    <option value="Beaucoup" name="choix_3">Me correspond beaucoup</option>
                    <option value="Parfaitement" name="choix_4">Me correspond parfaitement</option>
                ...
                <select id="question_12" name="question_12">
                    <option value="Pas" name="choix_1">Ne me correspond pas</option>
                    <option value="Un peu" name="choix_2">Me correspond un peu</option>
                    <option value="Beaucoup" name="choix_3">Me correspond beaucoup</option>
                    <option value="Parfaitement" name="choix_4">Me correspond parfaitement</option>
